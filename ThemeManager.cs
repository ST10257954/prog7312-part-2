...
namespace MunicipalServicesApp
{
    ...
    {
        // === COLOR PALETTE (based on your provided reference) ===
        public static readonly Color EmeraldDark = Color.FromArgb(27, 94, 32);   // Deep header base
        public static readonly Color EmeraldMid = Color.FromArgb(46, 125, 50);   // Medium green
        public static readonly Color EmeraldLight = Color.FromArgb(56, 142, 60); // Hover
        public static readonly Color BackgroundLight = Color.FromArgb(239, 242, 239); // Light grey-green background
